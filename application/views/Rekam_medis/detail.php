          ...
          <div class="content w-full h-full mx-auto">
              ...
              <div class="w-full rounded-3xl p-10 my-8 bg-Bg4-30 shadow-Card">
                  <table class="table w-full">
                      ...
                      <tbody>
                          <tr>
                              <th class="p-light text-center">1</th>
                              <td class="p-light text-center">Tanggal_Masuk</td>
                              <td class="p-light text-center">Tanggal_Keluar</td>
                              <td class="p-light text-center">Diagnosa</td>
                              <td class="p-light text-center">Obat</td>
