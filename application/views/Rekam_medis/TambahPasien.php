<div class="flex h-screen bg-gray-100">
    ...
    <main class="flex-1 bg-gray-100 ml-[70px]">
        ...
        <div class="content mt-[50px] mr-[70px] flex justify-center items-center">
            <div class="size-full rounded-3xl p-8">
                ...
                <div class="data-1">
            <form class="ml-10 mt-8 mr-10 mb-8" action=""  method="post">
              ...
              <br>
              <div class="border-t opacity-30 border-gray-300 my-2"></div>
              <br>
              <!-- Button Tambah Data Pasien -->
               <div class="btn-simpan flex justify-end">
                 <button type="submit" name="simpanPasien" id="prevBtn" class="btn btn-info text-white text-opacity-90" style="font-size: 16px;">Selanjutnya</button>
               </div>
            </form>        
          </div>
